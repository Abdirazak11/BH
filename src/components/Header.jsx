...
const BORAMA_IMG =
  "https://upload.wikimedia.org/wikipedia/commons/thumb/0/05/Borama_City.jpg/1280px-Borama_City.jpg";
    ...
    <>
      ...
      <nav className="sticky top-0 z-50 bg-white/95 backdrop-blur border-b border-slate-100 shadow-sm">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 h-16 flex items-center gap-4">
          ...
          {/* Logo */}
          <a href="/" className="flex items-center gap-2.5 flex-shrink-0 mr-4">
            ...
            <div className="leading-tight">
              <div className="font-extrabold text-base text-blue-700 tracking-tight leading-none">Borama</div>
              <div className="font-semibold text-xs text-slate-500 leading-none">Homes</div>
            </div>
          </a>
